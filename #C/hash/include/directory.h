...
*/
extern struct dir{
	struct contact** liste_de_contact;
	uint32_t taille;};
...
extern int taille_occupee(struct dir* dir);

extern int reorganise_tout(struct dir* dir);

extern struct dir* reorganise_vraiment_tout(struct dir** dir);
